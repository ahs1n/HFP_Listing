...
import static edu.aku.hassannaqvi.hfplisting.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.hfplisting.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.hfplisting.adapters.SyncListAdapter;
...
import edu.aku.hassannaqvi.hfplisting.workers.PhotoUploadWorker2;
    ...
    public void ProcessStart(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnUpload:
                ...
                // Vaccinations
                uploadTables.add(new SyncModel(TableContracts.ChildrenTable.TABLE_NAME));
                try {
                    uploadData.add(db.getUnsyncedChildren());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(Forms): " + e.getMessage());
                    Toast.makeText(this, "JSONException(Forms): " + e.getMessage(), Toast.LENGTH_SHORT).show();
